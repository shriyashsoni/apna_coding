...
const initialMessage: ChatMessage = {
  role: "assistant",
  content:
    "Hi! I'm your Event AI Assistant. Ask me about finding tech events, networking strategies, event planning tips, or how to make the most of meetups and conferences.",
};

export function EventChatAssistant() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('event-advisor-chat', {
        body: {
      ...
      console.error(error);
      toast.error("AI assistant is unavailable. Please try again soon.");
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-border bg-muted/50">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-sm">Event AI Assistant</h3>
                  <p className="text-xs text-muted-foreground">
                    Powered by Apna Coding
                  </p>
                </div>
              </div>
              <Button
