  ...
  return (
    ...
    >
      <div className="md:w-64 h-48 md:h-auto bg-muted/50 relative">
        {(hackathon.bannerImage || hackathon.posterImage || hackathon.image || hackathon.image_url) ? (
          <img
            src={hackathon.bannerImage || hackathon.posterImage || hackathon.image || hackathon.image_url}
            ...
            onError={(e) => {
              ...
              } else if (img.src === hackathon.image && hackathon.image_url) {
                img.src = hackathon.image_url;
              } else {
